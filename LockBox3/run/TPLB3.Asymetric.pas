...
unit TPLB3.Asymetric;
interface
uses Classes, TPLB3.StreamCipher, TPLB3.CodecIntf;
...
uses SysUtils, TPLB3.StreamToBlock, TPLB3.AES, TPLB3.CBC, TPLB3.Codec,
     TPLB3.PointerArithmetic, Math;
{ TAsymetricKeyPair }
...
if PlainText is TMemoryStream then
    begin
    FSymetricCodec.EncryptMemory(
      MemStrmOffset( TMemoryStream( Plaintext), Plaintext.Position)^,
      Sz);
