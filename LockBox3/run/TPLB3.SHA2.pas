...
interface
uses classes, TPLB3.HashDsc, TPLB3.StreamCipher, TPLB3.Decorators;
...
uses TPLB3.BinaryUtils, TPLB3.StreamUtils, TPLB3.PointerArithmetic,
     TPLB3.IntegerUtils, TPLB3.Constants, TPLB3.I18n;
