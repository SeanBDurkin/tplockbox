...
interface
uses
  TPLB3.HugeCardinal, Classes, TPLB3.MemoryStreamPool, TPLB3.StreamCipher,
  TPLB3.BlockCipher, TPLB3.Hash;
...
uses TPLB3.PointerArithmetic, SysUtils, Math, TPLB3.SHA1,
     TPLB3.HashDsc, TPLB3.StreamUtils, SyncObjs, TPLB3.Random, TPLB3.I18n;
