...
TSymetricEncryptionOption = (
  optUseGivenIV,                  // This option is obselete.
  optOpenSSL_CompatibilityMode,   // This option is obselete.
  optSuppressIVSeedPrependage     // Normally the low 8 bytes of the IV (the "IV seed" is prepended to ciphertext output upon encryption.
                                  //  If you set this option, the prepending will not occur, and you must use the OnSetIV event to
                                  //  set and/or capture the IV, and transmit it yourself via a side channel.
  );
