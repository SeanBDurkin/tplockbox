...
uses TPLB3.RSA_Primitives, SysUtils, Math, TPLB3.HugeCardinalUtils,
...
try
TPLB3.HugeCardinalUtils.Compute_RSA_Fundamentals_2Factors(
...
if Succeeded then
  ...
  Monitor := TMonitor.Create( ProgressEvent, ProgressSender);
  try
  OpRes := TPLB3.RSA_Primitives.RSASSA_PSS_SIGN(
