...
const
  ...
  TPLB3Runtime_SVN_Keyword_HeadURL : UTF8String = '$HeadURL: https://svn.code.sf.net/p/tplockbox/code/tags/LB%203.4.1%2012-Nov-2011/run/utilities/uTPLb_SVN_Keywords.pas $';
