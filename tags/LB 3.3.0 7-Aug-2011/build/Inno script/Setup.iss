...
#define OutputDir "V:\Projects\TurboPower\LockBox3\Executable bay"
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, "&", "&&")}}"; Flags: nowait postinstall skipifsilent; Components: Demo; Tasks: Compile
