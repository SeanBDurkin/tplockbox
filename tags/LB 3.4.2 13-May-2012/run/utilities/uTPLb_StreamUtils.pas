...
function  Stream_to_Base64( Source: TStream; const Transform: ansistring = ''): ansistring;

procedure Base64_to_stream( const Base64: ansistring; Destin: TStream);

procedure CustomBase64_to_stream( const Base64: ansistring; Destin: TStream;
