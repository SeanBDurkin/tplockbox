...
TSHA1_Hasher = class( TInterfacedObject, IHasher)
  private
    ...
    procedure  Burn;
    function   SelfTest_Source: ansistring;
    function   SelfTest_ReferenceHashValue: ansistring;
  end;
...
function TSHA1_Hasher.SelfTest_Source: ansistring;
...
function TSHA1_Hasher.SelfTest_ReferenceHashValue: ansistring;
// From sample 2 of Appendix B of reference 1.
begin
