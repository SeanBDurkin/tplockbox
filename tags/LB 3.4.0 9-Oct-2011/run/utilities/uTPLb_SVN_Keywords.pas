...
const
  ...
  TPLB3Runtime_SVN_Keyword_HeadURL : UTF8String = '$HeadURL: https://svn.code.sf.net/p/tplockbox/code/tags/LB%203.4.0%209-Oct-2011/run/utilities/uTPLb_SVN_Keywords.pas $';
