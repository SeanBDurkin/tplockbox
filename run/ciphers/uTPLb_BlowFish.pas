...
function ReverseEndien32( Value: uint32): uint32; inline;
begin
...
function TBlowFish.SelfTest_Ciphertext: ansistring;
...
function AnsiToBigEndienHex( const StraightAnsiValue: ansistring): ansistring;
var
  L, i: integer;
  C: byte;
...
function TBlowFish.SelfTest_Key: ansistring;
// From http://webnet77.com/cgi-bin/helpers/blowfish.pl
var
  KeyAsString, s: ansistring;
...
function TBlowFish.SelfTest_Plaintext: ansistring;
// From http://webnet77.com/cgi-bin/helpers/blowfish.pl
begin
