...
uses SysUtils, uTPLb_HashDsc, uTPLb_BinaryUtils, uTPLb_StreamUtils,
     ...
     uTPLb_IntegerUtils, uTPLb_RSA_Primitives, Forms;
...
const
  Test_n: ansistring = // n (little-endien; base64)
    'u9GFdi6di8zy/ZoPVdyOjtXdozDgVWXPCkHYIZ1DDsLI+rwhkY9CdnlJ6kjAtTOneme' +
    'V5n/+l9xuzrI4d1x+UlQegAkQSgLbhWp9XZNrz80SfVals7e+/cIAxIi4v/n1NP2VVG' +
    'l6ABfZr+qnv3EZVhf+nwqwForIgsdEuVmSy8k=';
  Test_n_bits = 1024;

  Test_e: ansistring = // e (little-endien; base64)
    'AQAB';
  Test_e_bits = 17;

  Test_d: ansistring = // d (little-endien; base64)
    'cY9AhN6Jz6bQ0DVeoifJWTgMl5U6qvoDQX/d+Jsi8Tw2PfUP0RaAuHiiCP2qPS7ScxR' +
    '3fXxpRI2IibNEcClGklXzXyKm3Q2p20/dz2LDjB8125fRF3i/jabGqZQEv2lOfN1NIC' +
    'jlZxyM9e19IRlJHg3TItmr2ELAjRYUjQWjqic=';
  Test_d_bits = 1022;

  Test_AES256Key: ansistring = // (base64; LoadFromStream)
    '+KcK4snvh88mf8NxcdU3ri1HSPyqRu1pb0+pEB511jE=';
...
for j := 1 to 3 do
  ...
  for i := 1 to 10 do
    ...
    Check( RSAES_OAEP_DECRYPT( d, n, Ciphertext, Recon), 'RSAES_OAEP_DECRYPT');
...
var
  ...
  function MakeHuge( const Definition: ansistring; BitLen: cardinal)
    : THugeCardinal;
  begin
  Tmp.Size := 0;
...
Ciphertext := TMemoryStream.Create;
Recon      := TMemoryStream.Create;
n := MakeHuge( Test_n, Test_n_bits);
e := MakeHuge( Test_e, Test_e_bits);
d := MakeHuge( Test_d, Test_d_bits);
...
Check( RSAES_OAEP_DECRYPT( d, n, Ciphertext, Recon),
  'RSAES_OAEP_DECRYPT');
...
const
 RSA_512_SampleKey1: ansistring =
  'QAAAADfRWmA3nhVNNvqB0CLoy1lvP6VwuPRY0gYMtGjS+G3vPVZG/adCkgcAuhduuzR' +
  'af42JCz75N8vrSS66owu2NWRAAAAA0YnbSszKdiO+s9zOiJizwIjK11cvOISf3jmFqB' +
  'iDCVKojcmJbnPEPsAbUlHx1oqpI4EpQuooOIC/3eELq0gZFAMAAAABAAE=';

 RSA_512_SampleKey2: ansistring =
  'QAAAAB90ZNa8vuzPpmWuWReBRuE12r/oAfFMJdBk8XfTIHB26+o1u1VtwV0ORYaqR/O' +
  '4dkvhfF8Eb1LgzRZzf1vh9JlAAAAAcenoFSj7DtDGUByUhO3zcB+eND0/sOn1Fqaizm' +
  '+qUv1RUUg+iXnQw1qZVlLliOzvZw3k01M2myXAsJONLVXYDwMAAAABAAE=';

 RSA_1024_SampleKey1: ansistring =
  'gAAAAIWILE/fqXIjMtXbxffzixJ3T71Kg+JsSzwuEuqbwP5y/D2f7XluAC4cYoCU3qA' +
  'WfRy23JaR+rXAWFMw2J/MSEN43Vbq1RHis0jeb4JD44Y9D1zV+sJ8CIWhzp38QzqhGb' +
  'PMDAFDQXwd9Hf5Ch9qoh7OJR7KWFBWZuA5kK/eiF2CgAAAABMwrc8ZDRGbb8uWsTOcm' +
  'sV0DoQ6gLZTLwSOAsjadAmPHviXRleVIQaBeruwuWSYUBbOJNQrPb095KM9s7BDlxSO' +
  'WJnvBkGYQx9ZXbHdwrMDlKQEkpkoetkbGSWZGLBRRCW3muhQIIXNtQ1ABUASi9HKuno' +
  'zojA3/qbs5HHn1Y0gAwAAAAEAAQ==';

 RSA_1024_SampleKey2: ansistring =
  'gAAAAC9TuThwZQG596+UXAwLGLR5gdhNns4RmB4a/QBq0PLfaX8QiLhx4ziihWRHh2u' +
  'AtYM7TgWFegIv5ZJ75uOjpyOHNx/qNhrUwRUzCi5OT5Atl7iDwPz42uqUjJNoDOpsBx' +
  'lXhWIZUFrer3jY5b/ZJiOrt+A+I7LhaEmCbLsb9MB8gAAAAN3PcBC72KBGVQXgZJWQw' +
  'U24e9cGKYu3h4J6ujTqfdWR21QQJGbWjbl9UG6JdLSxsESxQ2FcPa0s/UWfQEdmmRhK' +
  'NjGYvSiLnlOjoUdJiXjrQ1n0lUcR/Z7+pYFdtY3P12JQ9Nml7jBwYbMFvddqh4qgPkJ' +
...
const
  sTestPlaintext: ansistring = 'Test me!';
var
  x, y, recon_x: ansistring;
begin
x := sTestPlaintext;
