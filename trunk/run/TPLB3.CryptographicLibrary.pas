...
uses
  Math, SysUtils, TPLB3.I18n,

  // Chain modes:
  TPLB3.ECB,         TPLB3.CBC,      TPLB3.PCBC,
  TPLB3.CFB_Block,   TPLB3.CFB_8Bit, TPLB3.OFB,
  TPLB3.CTR,

  // Hashes
  TPLB3.SHA1, TPLB3.SHA2, TPLB3.MD5,

  // Stream mode
  TPLB3.StreamToBlock, TPLB3.Base64, TPLB3.RSA_Engine, TPLB3.XXTEA,

  // Block mode
  TPLB3.AES, TPLB3.DES, TPLB3.TDES, TPLB3.BlowFish, TPLB3.TwoFish;
