...
begin
  ...
  try
    case cbxKeyType.ItemIndex of
      ...
      1: GenerateLMDKey(Key, SizeOf(Key), TEncoding.ANSI.GetBytes(AnsiUpperCase(edtPassphrase.Text)));
      2: GenerateLMDKey(Key, SizeOf(Key), TEncoding.ANSI.GetBytes(edtPassphrase.Text));
    end;
