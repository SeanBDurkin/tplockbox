...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = L207vd61.bpl
OBJFILES = L207vd61.obj ..\source\LbDesign.obj ..\source\LbKeyEd2.obj \
    ..\source\LbKeyEd1.obj
RESFILES = L207vd61.res ..\source\LbDesign.dcr
MAINSOURCE = L207vd61.cpp
...
IDLGENFILES = 
LIBRARIES = 
PACKAGES = rtl.bpi vcl.bpi vclx.bpi designide.bpi L207_r61.bpi
...
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower LockBox 2.07 Design-time package - VCL61" -aa -Tpp -Gpd -x \
    -Gn -Gl -Gi
# ---------------------------------------------------------------------------
