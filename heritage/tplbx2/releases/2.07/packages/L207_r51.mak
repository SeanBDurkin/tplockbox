...
OBJFILES = ..\source\LbUtils.obj ..\source\LbBigInt.obj ..\source\LBCIPHER.obj \
    ...
    ..\source\LbString.obj ..\source\LbAsym.obj L207_r51.obj
RESFILES = L207_r51.res
MAINSOURCE = L207_r51.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
PFLAGS = -$Y- -$L- -$D- -$C- -v -JPHNE -M
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower LockBox 2.07 Run-time package - VCL51" -aa -Tpp -Gpr -x -Gn \
    -Gl -Gi
# ---------------------------------------------------------------------------
